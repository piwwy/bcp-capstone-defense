          ...
          <div className="flex items-center gap-4">
             ...
             <div className="relative group">
                ...
                <input 
                  ...
                  className="bg-gray-50 border border-gray-200 text-gray-700 text-sm rounded-full focus:ring-2 focus:ring-blue-100 focus:border-blue-500 block w-64 pl-10 p-2.5 transition-all outline-none"
                />
