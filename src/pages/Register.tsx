...
const Register: React.FC = () => {
  ...
  // --- CLEAN SUBMIT LOGIC (MANUAL ONLY) ---
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (authData.user) {
        // 3. Save Profile to Database (Using exact column names)
        ...
        const { error: profileError } = await supabase
          ...
          .upsert([
            { 
              ...
              mobile_number: formData.mobile, // Matches SQL "mobile_number"
        ...
        // 4. Force Logout (So they can't browse without approval)
        await supabase.auth.signOut();

        // 5. Success!
        showToast('success', 'Application Submitted!', 'Redirecting to confirmation...');
