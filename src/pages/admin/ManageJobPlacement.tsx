...
const ManageJobPlacement: React.FC = () => {
  ...
  return (
    <AdminPageLayout title="Job Placement Logs" subtitle="Track alumni employment and career data" icon={Briefcase}>
      ...
      {/* Hero Banner */}
      <div className="relative h-[180px] rounded-[2.5rem] bg-gradient-to-r from-blue-800 via-indigo-700 to-violet-700 overflow-hidden shadow-2xl flex items-center px-10 mb-8">
        ...
        <div className="relative z-10 flex items-center justify-between w-full">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <span className="bg-white/10 border border-white/20 text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">Placement Records</span>
            </div>
            <h2 className="text-3xl font-black text-white tracking-tighter">Job Placement Logs</h2>
            <p className="text-blue-100 text-sm font-medium mt-1">Track alumni employment history & career progression</p>
          </div>
          <div className="hidden md:flex items-center gap-4">
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-5 py-3 text-center">
              <p className="text-2xl font-black text-white">{stats.uniqueAlumni}</p>
              <p className="text-[10px] font-bold text-blue-200 uppercase tracking-widest">Alumni</p>
            </div>
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl px-5 py-3 text-center">
              <p className="text-2xl font-black text-white">{stats.uniqueCompanies}</p>
              <p className="text-[10px] font-bold text-blue-200 uppercase tracking-widest">Companies</p>
            </div>
          </div>
        </div>
