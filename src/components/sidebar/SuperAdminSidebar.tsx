  ...
  const menuItems = [
    {
      ...
      subItems: [{ name: "Dashboard", path: "/superadmin/dashboard" }],
    },
    {
      ...
      subItems: [
        ...
        { name: "Admin Accounts", path: "/superadmin/users/admins" },
        { name: "Alumni Accounts", path: "/superadmin/users/alumni" },
      ],
    },
    {
      name: "Access Control",
      icon: Shield,
      subItems: [
        { name: "Roles & Permissions", path: "/superadmin/roles" },
        { name: "Audit Logs", path: "/superadmin/logs" },
      ],
    },
    {
      ...
      icon: BarChart3,
      subItems: [
        { name: "System Analytics", path: "/superadmin/analytics" },
        { name: "Generated Reports", path: "/superadmin/reports" },
      ],
    },
    {
      ...
      icon: Database,
      subItems: [
        { name: "Backup & Restore", path: "/superadmin/database" },
        { name: "System Settings", path: "/superadmin/config" },
      ],
    },
    {
      name: "Preferences",
      icon: Settings,
      subItems: [
        { name: "Account Settings", path: "/superadmin/account" },
