  ...
  const menuItems = [
    {
      ...
      subItems: [{ name: "Dashboard", path: "/alumni/dashboard" }],
    },
    {
      name: "My Profile",
      icon: UserCircle2,
      subItems: [
        { name: "View Profile", path: "/alumni/profile" },
        { name: "Update Request", path: "/alumni/profile/update" },
      ],
    },
    {
      name: "Jobs & Career",
      ...
      subItems: [
        ...
        { name: "Applied Jobs", path: "/alumni/applied" },
      ],
    },
    {
      name: "Events",
      icon: Calendar,
      subItems: [
        { name: "Upcoming Events", path: "/alumni/events/upcoming" },
        { name: "My Attendance", path: "/alumni/events/attendance" },
      ],
    },
    {
      ...
      icon: MessageSquare,
      subItems: [
        { name: "Send Feedback", path: "/alumni/feedback" },
        { name: "Reports", path: "/alumni/reports" },
      ],
    },
    {
      name: "Documents",
      icon: FileText,
      subItems: [
        { name: "Certificates", path: "/alumni/certificates" },
        { name: "Request Form", path: "/alumni/documents/request" },
      ],
    },
  ];
