...
import {
  ...
  Repeat, X, Lock, Clock, History, Cpu
} from 'lucide-react';
import {
...
const DashboardSuperAdmin = () => {
  ...
  return (
    <div className="p-8 space-y-8 bg-gray-50/50 min-h-screen animate-in fade-in duration-500">
      ...
      <div className="bg-gradient-to-r from-violet-700 to-fuchsia-700 rounded-3xl p-6 text-white shadow-lg">
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div className="flex items-start gap-4">
            ...
            <div>
              <p className="text-[10px] font-black uppercase tracking-widest text-violet-100">AI + n8n Forecast Sync</p>
          ...
          <div className="text-right">
            <p className="text-[10px] uppercase tracking-widest font-black text-violet-100">Last Synced</p>
            ...
            <Link to="/superadmin/train-ai" className="inline-flex items-center gap-2 mt-3 px-4 py-2 rounded-xl bg-white text-violet-700 text-xs font-black hover:bg-violet-50 transition-colors">
